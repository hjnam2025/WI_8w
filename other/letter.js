document.addEventListener('DOMContentLoaded', () => {
    ...
    const tooltipElement = document.getElementById('overlap-tooltip');
    const crossLinkBtn = document.getElementById('cross-link-btn');

    // [안전 장치] 전환 오버레이가 HTML에 없으면 JS가 강제로 생성함
    ...
    let eclipseType = localStorage.getItem('selectedEclipseType') || 'Solar';
    ...
    const tracks = [
        {
            ...
            solarTooltipText: "<span class='tooltip-header'>불개</span><br>암흑나라는 해와 달이 없고 사나운 불개만 사는 곳이다. 암흑나라의 왕은 불개에게 나라에 없는 해와 달을 훔쳐 오라고 명령한다. 불개는 해를 물어 오려 했지만, 너무 뜨거워서 도중에 뱉어내기를 반복했다. 달을 물었을 때는 너무 차가워서 뱉어낼 수밖에 없었다.<br>이렇게 불개가 해와 달을 물었다 뱉었다 하여 지구에 일식과 월식이 생겼다고 한다.",
            lunarTooltipText: "<span class='tooltip-header'>늑대 스콜</span><br>북유럽 신화의 신들은 거인족이나 늑대와 끊임없는 싸움을 벌여 서로 죽고 죽인다. 해마차를 탄 여신 솔과 달마차를 탄 남동생 마니 역시 늑대 스콜과 하티에게 각각 쫓겼다. 태양과 달이 언제나 같은 방향으로 열심히 달리는 것은 바로 늑대에게 잡아먹히지 않기 위한 필사의 도주라는 것이다. 간혹 솔과 마니가 위기에 빠져 늑대들에게 거의 잡아먹히기 직전이 되면 일식이나 월식이 일어난다. 고대 노르웨이인들은 솔과 마니가 언젠가는 늑대에게 잡히고, 이것이 결국 신과 지구를 멸망으로 이끄는 ‘라그나로크’로 이어질 것이라고 두려워했다.",
        ...
        },
        {
            ...
            solarTooltipText: "<span class='tooltip-header'>라후</span><br>고대 인도 신화에 따르면, 일식과 월식은 유성의 왕이자 악마의 별인 라후(Rāhu)에 의해 일어난다. 신들이 불사의 음료 아므리타를 마실 때, 라후는 신으로 변장하여 숨어들었다.<br>하지만 해와 달이 그의 정체를 간파하여 대신(大神) 비슈누에게 알렸고, 라후가 아므리타를 한 모금 마시자마자 비슈누의 원반에 목이 잘린다.<br>이미 아므리타를 마셔 불사가 된 라후의 머리는 별이 되어 하늘을 떠다니며, 자신을 고자질한 태양과 달을 쫓아가 삼켜서 일식과 월식을 일으키는 것이 옛 한을 갚는 행동이라고 한다.",
            lunarTooltipText: "<span class='tooltip-header'>라와 아펩</span><br>고대 이집트 신화에서는 매의 얼굴을 가진 태양신 ‘라’가 주인공이자 절대신이다. 라는 낮의 이름으로, 아침에는 케프리, 저녁에는 아툼이라고 불리기도 한다. 라는 매일 ‘만제트’라고 불리는 초생달 모양의 배를 타고 하늘을 가로지른다. 밤이 되면 라는 지하세계를 거쳐 동쪽으로 돌아온다. 이 과정에서 라는 저승을 위협하는 악마인 거대한 독사 ‘아펩’과 싸우게 되는데, 이 과정에서 아펩이 일시적인 승리를 거두게 되면 일식이 일어난다. 아펩은 매일 밤 라에게 칼이나 창으로 찔려 죽지만, 다음 날이면 다시 살아나 공격하는 불사의 존재다.",
        ...
        },
        {
            ...
            solarTooltipText: "<span class='tooltip-header'>체로키 인디언 신화</span><br>체로키 인디언 신화에서 해는 달을 질투하여 지구에 뜨거운 열을 내뿜어 사람들이 죽었다. 현자는 인디언을 방울뱀으로 변신시켜 해의 딸에게 보냈으나, 방울뱀은 실수로 딸을 죽인다. 딸의 죽음에 해가 흘린 눈물은 홍수를 일으켰다. 사람들이 딸을 되살리는 데 실패하자 해는 더욱 강한 열기를 뿜어냈다.<br>결국 사람들은 해의 분노를 달래기 위해 노래하고 춤추기 시작했으며, 이것이 인디언 축제의 기원이다. 일식은 해가 이 노래와 춤을 들을 때 딸을 잃은 슬픔을 떠올려 일어나는 현상이다.",
            lunarTooltipText: "<span class='tooltip-header'>아마테라스와 스사노오</span><br>다카마노하라의 지배자 아마테라스는 동생 스사노오가 나라를 빼앗으려 한다고 여긴다. 스사노오가 자신의 결백을 증명했으나 폭주하여 질서를 어지럽히자, 아마테라스가 아메노이와도 동굴에 숨어 세상이 어둠에 잠기게 된다.<br>이에 신들은 아메노우즈메의 춤으로 아마테라스를 유인한다. 궁금해서 동굴 밖으로 고개를 내민 아마테라스를 신들이 재빨리 끌어냈고, 세상에는 다시 빛이 돌아왔다.",
    ...
    // 시작 안내
    if (startInstruction) {
        startInstruction.innerHTML = (eclipseType === 'Solar') 
            ? "<< 달 클릭 후 태양 쪽으로 드래그 >>" 
            : "<< 그림자 클릭 후 달 쪽으로 드래그 >>";
    }

    // --- 배경 타일 생성 ---
    const lyricsN = `All that you touch And all that you see...`; 
    ...
    if (solarMoon) solarMoon.addEventListener('mousedown', onDragStart);
    if (earthShadow) earthShadow.addEventListener('mousedown', onDragStart);
    if (prevTrackBtnSolar) prevTrackBtnSolar.addEventListener('click', handlePrevTrack);
    if (nextTrackBtnSolar) nextTrackBtnSolar.addEventListener('click', handleNextTrack);
    if (prevTrackBtnLunar) prevTrackBtnLunar.addEventListener('click', handlePrevTrack);
    if (nextTrackBtnLunar) nextTrackBtnLunar.addEventListener('click', handleNextTrack);
    ...
    // --- [화면 전환 함수] ---
    function switchEclipseMode(newType) {
        // 오버레이가 없으면 실행 불가하므로 확인
        ...
        setTimeout(() => {
            eclipseType = newType;
            localStorage.setItem('selectedEclipseType', newType);

            // 기존 요소 숨김
            hideAllElements();

            // 위치 초기화
            targetX = RESET_X; moonX = RESET_X;
            targetY = RESET_Y; moonY = RESET_Y;
            isDragging = false;

            // 새 모드 초기화
            if (eclipseType === 'Solar') initSolar();
            else initLunar();
    ...
    function hideAllElements() {
        [sunContainer, solarMoon, lunarMoon, earthShadow, 
         prevTrackBtnSolar, nextTrackBtnSolar, prevTrackBtnLunar, nextTrackBtnLunar, 
         solarInstruction, lunarInstruction].forEach(el => {
    ...
    function initSolar() {
        hideAllElements();
        if (sunContainer) sunContainer.style.display = 'flex';
        if (solarMoon) solarMoon.style.display = 'block';
        if (prevTrackBtnSolar) prevTrackBtnSolar.style.display = 'block';
        if (nextTrackBtnSolar) nextTrackBtnSolar.style.display = 'block';
        ...
        // 버튼 설정 (월식으로 가기)
        if (crossLinkBtn) {
            crossLinkBtn.textContent = "월식 이야기도 읽으러 가보세요 →";
            crossLinkBtn.className = 'cross-link-btn solar-pos';
            crossLinkBtn.style.display = 'block';
            // 기존 이벤트 제거를 위해 프로퍼티 할당 방식 사용
            crossLinkBtn.onclick = () => switchEclipseMode('Lunar');
        }
    }

    function initLunar() {
        hideAllElements();
        if (lunarMoon) lunarMoon.style.display = 'block';
        if (earthShadow) earthShadow.style.display = 'block';
        if (prevTrackBtnLunar) prevTrackBtnLunar.style.display = 'block';
        if (nextTrackBtnLunar) nextTrackBtnLunar.style.display = 'block';
        ...
        // 버튼 설정 (일식으로 가기)
        if (crossLinkBtn) {
            crossLinkBtn.textContent = "일식 이야기도 읽으러 가보세요 →";
            crossLinkBtn.className = 'cross-link-btn lunar-pos';
            crossLinkBtn.style.display = 'block';
            crossLinkBtn.onclick = () => switchEclipseMode('Solar');
        }
    }
    ...
    function handlePrevTrack() {
        ...
        if(tooltipElement) { tooltipElement.style.opacity = 0; tooltipElement.style.display = 'none'; }
    }
    ...
    function changeTrack(index, playAudio) {
        ...
        if (playAudio) audio.play().catch(e => console.error(e));
    ...
    function updateEffects() {
        ...
        let distance, targetRect, currentTooltipText = "";
        ...
        if (eclipseType === 'Solar') {
            const centerOverlapThreshold = 50; 
            if (isDragging) {
                if(solarMoon) solarMoon.style.filter = `brightness(${1 - effectRatio * 0.8})`;
                if (distance < centerOverlapThreshold) showTooltip = true; 
            }
            if (isDragging && effectRatio > 0.85) {
            ...
            const lunarOverlapThreshold = 50; 
            if (isDragging) {
        ...
        if (showTooltip && isDragging) {
            ...
            tooltipElement.style.opacity = 0;
             setTimeout(() => {
                 if (tooltipElement.style.opacity === '0') tooltipElement.style.display = 'none';
             }, 300); 
        }
    }
...
backBtn.onmouseenter = () => { if(img) img.src = '../other/imgs/home-fill.svg'; };
backBtn.onmouseleave = () => { if(img) img.src = '../other/imgs/home.svg'; };
}
